        ...
        <div className={styles.content_menu_left}>
          <DownMenu name='About us' href='/About'>
            <div className={styles.container_down}>
              ...
              <InfoText
                backgText={false}
                text='Мы создали панков в настоящем времени. И сейчас мы находимся в их соц сети. Но если вы дадите нам деняк, мы покажем, какие они были до, и какими будут в нашей игре.'
              />
            </div>
          </DownMenu>
          ...
          <DownMenu name='ROADMAP' href='/Roadmap'>
            ...
            <div className={styles.container_down}>
              <InfoText
                backgText={true}
                text='У нас планируется игра в 3 эпохах. Сейчас вам доступно только Панки XXI, но в будущем мы сделаем панки прошлого и будущего. '
              />
            </div>
          </DownMenu>
        </div>
